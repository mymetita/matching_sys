...
! function(r, u) {
    ...
    function h(e, n) { return Object.keys(n).forEach(function(t) { e[t] = n[t] }), e }
    r.ClassBody = function() { r.AddInBody(o), r.AddInBody("nk-apps-sidebar"), r.AddInBody(g), r.AddInBody(n) }, r.ClassNavMenu = function() { r.BreakClass("." + f, p.lg, { timeOut: 0 }), r.BreakClass("." + o, p.lg, { timeOut: 0 }), r.BreakClass("." + a, p.lg, { timeOut: 0 }), r.BreakClass("." + g, p.lg, { timeOut: 0, classAdd: e, ignore: i }), r.BreakClass("." + n, p.xl, { timeOut: 0, classAdd: e }), r.BreakClass("." + i, p.md, { timeOut: 0, classAdd: e }), c.on("resize", function() { r.BreakClass("." + f, p.lg), r.BreakClass("." + o, p.lg), r.BreakClass("." + a, p.lg), r.BreakClass("." + g, p.lg, { classAdd: e, ignore: i }), r.BreakClass("." + n, p.xl, { classAdd: e }), r.BreakClass("." + i, p.md, { classAdd: e }) }) }, r.Prettify = function() { window.prettyPrint && prettyPrint() }, r.Copied = function() {
        ...
        function e(t, e) {
            ...
            var s = "success" === e ? a.done : a.fail,
                r = "success" === e ? l : d;
            i.addClass(r).find(c).html(s), setTimeout(function() { i.removeClass(l + " " + d).find(c).html(a.text).blur(), i.find("input").blur() }, 2e3)
        }
        ClipboardJS.isSupported() ? new ClipboardJS(t).on("success", function(t) { e(t.trigger, "success"), t.clearSelection() }).on("error", function(t) { e(t.trigger, "error") }) : u(t).css("display", "none")
    ...
    }, r.PassSwitch = function() { r.Passcode(".passcode-switch") }, r.Toast = function(t, e, n) {
        ...
        if (s.position = s.position ? "toast-" + s.position : "toast-bottom-right", s.icon = "auto" === s.icon ? a : s.icon ? s.icon : "", s.ui = s.ui ? " " + s.ui : "", i = "" !== s.icon ? '<span class="toastr-icon"><em class="icon ' + s.icon + '"></em></span>' : "", "" !== (t = "" !== t ? i + '<div class="toastr-text">' + t + "</div>" : "")) {
            ...
            var r = { closeButton: !0, debug: !1, newestOnTop: !1, progressBar: !1, positionClass: s.position + s.ui, closeHtml: '<span class="btn-trigger">Close</span>', preventDuplicates: !0, showDuration: "1500", hideDuration: "1500", timeOut: "2000", toastClass: "toastr", extendedTimeOut: "3000" };
        ...
        var n = u(t || ".toggle"),
            ...
            s = e ? h(o, e) : o;
        r.TGL.screen(i), n.on("click", function(t) { a = this, r.Toggle.trigger(u(this).data("target"), s), t.preventDefault() }), d.on("mouseup", function(t) {
            if (a) {
                var e = u(a);
        ...
        var n = t || ".expand",
            i = { toggle: !0 },
            a = e ? h(i, e) : i;
        u(n).on("click", function(t) { r.Toggle.trigger(u(this).data("target"), a), t.preventDefault() })
        ...
        var n = u(t || ".nk-nav-toggle"),
            ...
            s = e ? h(o, e) : o;
        n.on("click", function(t) { r.Toggle.trigger(u(this).data("target"), s), t.preventDefault() }), d.on("mouseup", function(t) {!n.is(t.target) && 0 === n.has(t.target).length && !i.is(t.target) && 0 === i.has(t.target).length && r.Win.width < a && r.Toggle.removed(n.data("target"), s) }), c.on("resize", function() {
        ...
        i.exists() && (i.on("click", function(t) {
            ...
            var e = u(this).data("target"),
                n = u("[data-search=" + e + "]"),
                i = u("[data-target=" + e + "]");
            n.hasClass(a.active) ? (i.add(n).removeClass(a.active), setTimeout(function() { n.find("input").val("") }, a.timeout)) : (i.add(n).addClass(a.active), n.find("input").focus())
        }), d.on({ keyup: function(t) { "Escape" === t.key && i.add(o).removeClass(a.active) }, mouseup: function(t) { o.find("input").val() || o.is(t.target) || 0 !== o.has(t.target).length || i.is(t.target) || 0 !== i.has(t.target).length || i.add(o).removeClass(a.active) } }))
    }, r.Ani.formElm = function(t, e) {
        var n = { focus: "focused" },
            i = e ? h(n, e) : n;
        u(t).exists() && u(t).each(function() {
            var t = u(this);
            t.val() && t.parent().addClass(i.focus), t.on({ focus: function() { t.parent().addClass(i.focus) }, blur: function() { t.val() || t.parent().removeClass(i.focus) } })
        })
    ...
    }, r.Validate.init = function() { r.Validate(".form-validate", { errorElement: "span", errorClass: "invalid", errorPlacement: function(t, e) { t.appendTo(e.parent()) } }) }, r.Dropzone = function(t, n) {
        u(t).exists() && u(t).each(function() {
        ...
        u(t || ".dropdown-menu").on("click", function(t) { u(t.target).is(n) || t.stopPropagation() })
